...
from model.DeepOD.deepod.core.networks.ts_network_transformer import TSTransformerEncoder
from model.DeepOD.deepod.core.networks.ts_network_dilated_conv import DilatedConvEncoder
from model.DeepOD.deepod.core.networks.ts_network_tcn import TCNnet, TcnAE
# from deepod.core.base_transformer_network_dev import TSTransformerEncoder
from model.DeepOD.deepod.core.networks.network_utility import _instantiate_class, _handle_n_hidden
...
class MLPnet(torch.nn.Module):
    def __init__(self, n_features, n_hidden='500,100', n_output=20, mid_channels=None,
        ...
        self.network_representation = torch.nn.Sequential(*self.layers_representation)
        ...
        self.network_output = torch.nn.Sequential(*self.layers_output)        


    def forward(self, x):
        x_representation = self.network_representation(x)
        x_output = self.network_output(x_representation)
        return x_output, x_representation
