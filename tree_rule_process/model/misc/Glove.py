...
import bcolz
import numpy as np #np.float需要1.24之前的版本，否则将报错
...
if __name__ == "__main__":
    #pre-trained word embedding, Glove, needs to be download by 'wget https://nlp.stanford.edu/data/glove.6B.zip'
    # load_glove_to_binary('../../../glove', dimension=50, identifier='6B')
    load_glove_to_binary('./tree_rule_process/glove', dimension=50, identifier='6B')
